...
with logo_col:
    try:
        st.image("motion_apps/images/PA_log-cutout.png", width=110)
    except Exception:
        pass
...
try:
    st.image(
        "motion_apps/images/julien-tromeur-vW6pA7b98BQ-unsplash.jpg",
...
# =========================
try:
    with open("motion_apps/MotionAnalysis_UserGuide.pdf", "rb") as pdf_file:
